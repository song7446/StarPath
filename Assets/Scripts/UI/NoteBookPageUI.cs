...
public class NoteBookPageUI : MonoBehaviour
{
    ...
    private ConstellationRow _pageData;
    ...
    public void SetPageData(ConstellationRow data)
    {
        _pageData = data;
        ...
        if (isLeftPage)
        {
            ...
            {
                // constellationImage.sprite = data.Image;
        ...
        {
            if (titleText != null) titleText.text = data.Name_Kr;
            if (descText != null) descText.text = data.Explain_Kr;
        }
    }
    ...
    private void OnClickPolaroidButton()
    {
        ...
        Debug.Log($"{_pageData.Name_Kr} 폴라로이드 가이드로 변경!");
    }
